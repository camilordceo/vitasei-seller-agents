...
export default async function AgentDetailPage({ params }: { params: { id: string } }) {
  ...
  const initial: AgentEditorInitial = {
    ...
    paypalClientId: agent.paypal.paypalClientId,
    hasPaypalSecret: agent.paypal.hasPaypalSecret,
    paypalSandbox: agent.paypal.paypalSandbox,
    paypalTaxPercent: agent.paypal.paypalTaxPercent,
    paypalShipping: agent.paypal.paypalShipping,
    paypalMessage: agent.paypal.paypalMessage,
