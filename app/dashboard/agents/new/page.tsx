  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-slate-500">
        Pega los IDs de la nueva marca/número. La IA y el catálogo (vector store) los creas offline
        en OpenAI; aquí solo asocias los IDs. Al guardar, ese número empieza a responder con su IA.
      </p>
